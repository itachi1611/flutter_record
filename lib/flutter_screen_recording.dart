...
class FlutterScreenRecording {
  ...
  static Future<bool?> startRecordScreen(
    String name, {
    required RecordScreenResolution resolution,
    int? width,
    int? height,
    ...
    switch(resolution) {
      case RecordScreenResolution.sr720:
        width = 720;
        height = 1280;
        break;
      case RecordScreenResolution.sr1080:
        width = 1080;
        height = 1920;
        break;
      case RecordScreenResolution.srCustom:
      default:
        width = width ?? 600;
        height = height ?? 800;
        break;
